...
export const ResidentUnder750000: Question = {
  ...
  description: "Interest paid for the first home (value between RM500,001 and RM750,000), which you lived in and signed the agreement between January 1, 2026, and December 31, 2028.",
  inputType: {
    type: "number",
    isCurrency: true,
    totalLimit: {
