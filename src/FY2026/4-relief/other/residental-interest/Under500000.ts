...
export const ResidentUnder500000: Question = {
  ...
  description: "Interest paid for the first home (value not more than RM500,000), which you lived in and signed the agreement between January 1, 2026, and December 31, 2028.",
  inputType: {
    type: "number",
    isCurrency: true,
    totalLimit: {
