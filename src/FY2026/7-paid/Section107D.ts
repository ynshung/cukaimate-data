...
export const Section107D: Question = {
  ...
  explanatoryNotes: `Enter the total amount of the tax deduction of 2% made by the payer company for each cash payment to agents, dealers or distributors for the year 2026 in this item.
